...
run_as_user "cd ~/caldera && python3 -m venv .venv && source .venv/bin/activate && pip3 install -r requirements.txt" "Failed to install Caldera requirements. Do we have pip3 installed?"
